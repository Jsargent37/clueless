...
def handle_client(conn, addr):
    ...
    while connected:
        ...
        """
        the header coming in will contain the length of the message as an int followed by 
        padding that will make the message length 64 bytes long. That will be decoded into
        an int that can be used to then recieve the real message, which is sent next.
        """
